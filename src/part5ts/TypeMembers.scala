...
object TypeMembers extends App {
   ...
   */
  // LOCKED, no control on this stupid decision
  trait MList {
    type A
    def head: A
    def tail: MList
 ...
 //solution
  ...
  // NOT OK, we dont want this to compile, how to enforce at compile time. thus we added out trait, and now it wont compile
